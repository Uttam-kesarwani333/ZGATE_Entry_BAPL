...
*DATA(ls_header123) = VALUE #( gt_header[ 1 ] OPTIONAL ).
*
*DATA: lv_init_sec  TYPE i,
*      lv_final_sec TYPE i.
*
*" Convert Initial WT Time to seconds
*lv_init_sec =
*    ( ls_header123-init_wt_time+0(2) * 3600 ) +
*    ( ls_header123-init_wt_time+2(2) * 60 ) +
*    ( ls_header123-init_wt_time+4(2) ).
*
*" Convert Final WT Time to seconds
*lv_final_sec =
*    ( ls_header123-final_wt_time+0(2) * 3600 ) +
*    ( ls_header123-final_wt_time+2(2) * 60 ) +
*    ( ls_header123-final_wt_time+4(2) ).
*
*" Add 24 hours to initial time
*lv_init_sec = lv_init_sec + 24 * 3600.
*
*IF lv_init_sec < lv_final_sec.
*
*  " FAILED entry
*  APPEND VALUE #(
*      gatenumber  = ls_header123-gate_number
...
*  ) TO failed-weight.
*
*  " REPORTED entry with RAP message
*  APPEND VALUE #(
*      gatenumber           = ls_header123-gate_number
*      %state_area          = 'GRN_NUMBER'
*      %msg                 = NEW zcx_gate(
